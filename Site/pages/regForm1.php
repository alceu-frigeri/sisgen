...
<table id="regform" style="width:70%">
<tr>
<td style="text-align:right; width:30%">Comprovante Vínculo:</td><td style="te xt-align:left"><input type="file" name="studentfile" id="studentfile"/></td>
</tr>
</table>
</div>
<?php endif; ?>
...
for ($num=1; $num <= $MAXPAPERS; $num++) {
  ...
  if ($regForm) {
     echo "<tr>";
     echo "<td style='text-align:right;background-color:${bgcolor}'><font color='$color'>Identificador do Artigo #${num}</font></td>";
  ...
  echo "<tr>";
  echo "<td style='text-align:right; width:30%;background-color:${bgcolor}'><font color='$color'>Páginas Extras do Artigo #${num}:</font></td><td style='text-align:left'>";
  echo "<input type='radio' name='xtrapag${num}' id='xtrapag${num}' value='0' checked onclick='xtrapag($num,0)'>Nenhuma</input><br>";
  echo "<input type='radio' name='xtrapag${num}' id='xtrapag${num}' value='1'         onclick='xtrapag($num,1)'>Uma Página + R$50</input><br>";
  echo "<input type='radio' name='xtrapag${num}' id='xtrapag${num}' value='2'         onclick='xtrapag($num,2)'>Duas Páginas + R$100</input><br>";
  echo "</td>";
  echo "</tr>";
  if ($regForm) {
     echo "<tr>";
     echo "<td style='text-align:right; width:30%;background-color:${bgcolor}'><font color='$color'>Apresentação do Artigo #${num}:</font></td><td style='text-align:left'>";
  ...
  if ($regForm){
     ...
     echo "<table id='regform' style='width:70%'>";
     echo "<tr>";
     echo "<td style='text-align:right; width:30%;background-color:${bgcolor}'><font color='$color'>Apresentador do Artigo #${num}:</font></td>";
...
var valid = true;
    ...
    if (sba == 'sba') {
       ...
       txt2 += sbafile + "\n\n";
       if (document.getElementById('sbafile').files[0].size > MAXSIZE) {
    ...
    if (papersOK && titlecheck() && emailcheck() && filesOK) {
       if (SinglePhase) {
        if (confirm(txt)) {
	  return confirm(txt2);
	} else {
