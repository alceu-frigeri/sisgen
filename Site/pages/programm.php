...
<div class="row">
    <div class="col-sm-14">
<h2>PROGRAMAÇÃO  - SBAI 2017</h2><hr>
Porto Alegre (RS), 1 a 4 de outubro de 2017

<h2>Overview</h2><hr>
<?php include "prog-overview.php" ?>


<!--
<a href="http://easychair.org/smart-program/SBAI2017/"><h3>O programa completo (easychair) do Simpósio</h3></a><p>
-->

<a target='_BLANK' href="/sbai17/program.php"><h3>Proceedings do  Simpósio</h3></a><p>



</p><h3>Sessões Plenárias</h3><hr>
...
Now we have to answer the question, if it is possible to keep the aged people as long as possible at home to reduce costs but not the quality of services in medicine , care and general support.<br>
...
<ul>
    <li>	Mesa Redonda 01:  Controle e Otimização de Processos Industriais: Desafios e Perspectivas
	<ul>
	    <li>	Prof. Jorge Otávio Trierweiler (UFRGS) - Mediador
	    <li>	Prof. André Maitelli (UFRN) 
	    <li>	Eng. Herbert Teixeira - Consultor Sênior  da PETROBRAS
	    <li>	Eng. Roni Paul Aurich - Coordenador Geral de Elétrica, Instrumentação e Automação da CMPC - Celulose Riograndense

	</ul>
	<li>	Mesa Redonda 02: Desenvolvimento Nacional em Tecnologia de Defesa: Desafios e Oportunidades
	    <ul>
 <li> Prof. Edison Pignaton (UFRGS) - Mediador 
 <li> Prof. Luis Lamb (UFRGS) - Pró-reitor de Pesquisa
 <li> Gen. Ex. Adhemar da Costa Machado Filho - Exército Brasileiro
 <li> Capitão de Mar e Guerra José Joaquim Borges Ribeiro de Andrada - Marinha do Brasil
 <li> Cel. Aviador Fernando Nogueira Ventura - Núcleo de Gestão da Inovação do DCTA - Força Aérea Brasileira
 <li> Major-Brigadeiro-do-Ar R/1 Raul José Ferreira Dias - COMDEFESA-FIERGS
 <li> Eng. Ulf  Bogdawa -  Diretor da Skydrones
 <li> Eng. Marcos Arend -  Diretor da AEL
 <li> Eng. Gilberto Castro - Gerente de Engenharia da EMBRAER
 <li> Eng. Marcos Agmar de Lima Souza - Gerente de Desenvolvimento de Negócios da AVIBRAS


	    </ul>
	    <li>	Mesa Redonda 03:  Indústria 4.0: Tendências e Desafios
		<ul>
 <li> Prof. Carlos Eduardo Pereira (UFRGS/EMBRAPII) - Mediador
 <li> Prof. Alejandro Frank (UFRGS) 
 <li> Eng. Jorge Demoliner - Diretor de P&D&I da Exatron
 <li> Eng. Marcos Dillenburg - Gerente de P& D da NOVUS
 <li> Eng. Ricardo Torralba - Desenvolvedor de Negócios  da Siemens
 <li> Eng. Alexandre Sikler -  Gerente de Produto da Stihl

		</ul>
</ul>

</p><h3>Sessões Orais e de Pôster</h3><hr>
<!--Participantes inscritos no evento apresentarão as suas contribuições organizadas em seções técnicas e de pôster, a critério do Comitê de Programa. Cada apresentação oral terá duração de 20 minutos, sendo 15 minutos para apresentação e 5 minutos para questionamentos da plateia. Cada pôster terá 05 (cinco) minutos de apresentação oral para um grupo de avaliadores e deverá estar disponível durante o coffee-break e a seção técnica subsequente.  -->


<h4>Instruções para artigos em formato pôster:</h4>
<ol>
<li>     Será disponibilizado um porta-banner (pedestal) para a afixação de um pôster impresso.
<li>       As dimensões máximas do pôster devem ser: 120cm de altura e 80cm de largura.
<li>       Os pôsters devem fixados 10min antes do horário previsto para a sessão.
<li>      Durante todo o tempo da sessão um dos autores (ou apresentador
designado) deverá estar presente para interagir com os participantes.
<li>       O coordenador da sessão avaliará todos os pôsters ao longo da mesma.
</ol>

<h4>Instruções para apresentação oral:</h4>
<ol>
<li>       Em cada sala será disponibilizado um microcomputador conectado a um projetor. As apresentações deverão ser feitas utilizando este computador.
<li>       Os autores deverão chegar 10 min antes do início da sessão para descarregar a apresentação no computador da sala e se apresentar ao coordenador da seção. Não é necessário fazer o upload dos slides previamente no Easy Chair.
<li>       As apresentações devem ser preferencialmente no formato .pdf.
<li>       Cada artigo deverá ser apresentado em um total de 20min, sendo 15min para apresentação do autor e 5min para questionamentos.
</ol>



</p><h3>Minicursos</h3><hr>
...
<li>	Minicurso 03: Profa. Silvia Silva da Costa Botelho e Paulo Lilles Jorge Drews Junior - "Aprendizado Profundo - O que eu tenho a ver com isso?!";
<ul>
    <li> Introdução aos métodos de aprendizado profundo com aplicações em reconhecimento de imagens, reconstrução de padrões, tradução de idiomas, processamento de áudio, controle, dentre outros.  Apresentação colaborativa de ferramentas e brainstorming com os participantes. 
	Propostas de uso em Automação e Robótica (imageamento, veículos autônomos, síntese de som e e imagem)
</ul>
<li>	Minicurso 04: Prof. Walter Fetter Lages - "Robot Operational System (ROS): Introdução e Implementação de Controladores";
<ul>
<li>Este curso apresenta uma introdução ao Robot Operating System (ROS) com
