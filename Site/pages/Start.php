...
<form onsubmit='return validate()'  method='post' enctype='multipart/form-data' action='/sisgen/test-index.php?st=register'>
<input type='text' name='phase' value='subscribe' hidden />
<table id='regform'>
<tr>
<td style='text-align:right; width:30%'>Email:</td><td style='text-align:left'><input type='email' name='emailA' id='emailA' size='30' required <?php $emailcheck ?> /><span id='emailAdiff' style='color:white'>(diff.)</span></td>
</tr>
<tr>
<tr>
...
<tr>
<td style='text-align:right; width:30%'>Senha:</td><td style='text-align:left'><input type='password' name='passA' id='passA' size='30' pattern='(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$' title='Senha:Maiúscula+Minúsculas+Número/Simbolo, mínimo 8' required <?php $passcheck ?> /><span id='passAdiff' style='color:white'>(diff.)</span></td>
</tr>
<tr>
<tr>
<td style='text-align:right; width:30%'>Senha (Confirmação):</td><td style='text-align:left'><input type='password' name='passB' id='passB' size='30' pattern='(?=^.{8,}$)((?=.*\d)|(?=.*\W+))(?![.\n])(?=.*[A-Z])(?=.*[a-z]).*$' title='Senha:Maiúscula+Minúsculas+Número/Simbolo, mínimo 8' required <?php $passcheck ?> /><span id='passBdiff' style='color:white'>(diff.)</span></td>
</tr>
<tr><td></td>
<td>
...
<form method='post' enctype='multipart/form-data' action='/sisgen/test-index.php?st=login'>
...
<form method='post' enctype='multipart/form-data' action='/sisgen/test-index.php?st=passrecovery'>
...
<form method='post' enctype='multipart/form-data' action='/sisgen/test-index.php?st=valresend'>
<input type='text' name='phase' value='forgot' hidden />
<table id='regform'>
<tr>
<td style='text-align:right; width:30%'>Email:</td><td style='text-align:left'><input type='email' name='emailA' size='30' required /></td>
