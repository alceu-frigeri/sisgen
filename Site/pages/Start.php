...
<table id='regform'>
<tr>
<td style='text-align:right; width:30%'>Nome:</td><td style='text-align:left'><input type='text' name='name' id='name' size='30' pattern='<?php echo $GBLpattern['name']; ?>' required /></td>
</tr>

<tr>
<td style='text-align:right; width:30%'>Sobrenome:</td><td style='text-align:left'><input type='text' name='familyname' id='familyname' size='30' pattern='<?php echo $GBLpattern['name']; ?>' required /></td>
</tr>
...
<tr>
<td style='text-align:right; width:30%'>Senha:</td><td style='text-align:left'><input type='password' name='passA' id='passA' size='30' pattern='<?php echo $GBLpattern['passwd']; ?>' title='Senha:Maiúscula+Minúsculas+Número/Simbolo, mínimo 8' required <?php echo $passcheck; ?> /><span id='passAdiff' style='color:white'>(diff.)</span></td>
</tr>

<tr>
<td style='text-align:right; width:30%'>Senha (Confirmação):</td><td style='text-align:left'><input type='password' name='passB' id='passB' size='30' pattern='<?php echo $GBLpattern['passwd']; ?>' title='Senha:Maiúscula+Minúsculas+Número/Simbolo, mínimo 8' required <?php echo $passcheck; ?> /><span id='passBdiff' style='color:white'>(diff.)</span></td>
</tr>
<tr><td></td>
<td>
